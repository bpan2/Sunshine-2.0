...
public class Utility {
    ...
    public static boolean isMetric(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        return prefs.getString(context.getString(R.string.pref_general_units_key),
                context.getString(R.string.pref_general_units_metric_value))
                .equals(context.getString(R.string.pref_general_units_metric_value));
    }
